# FASP peprocessing file; written by Stefan Pfeiffer, 1.December 2017, last modified on 29.6.2018; 
...
./US_10.240 -fastx_truncate raw.fq -stripleft $primerleft -stripright $primerright \-fastqout strippedraw.fq # Output file: "strippedraw.fq"; XX -> type the length of your primers, left=forward primer; right = reverse primer; e.g. -stripleft 20 -stripright 19
echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
...
./US_10.240  -fastq_filter strippedraw.fq -fastq_maxee 1.0 \-fastaout filteredstripped.fa -relabel Filt # Output file: "filteredstripped.fa"; expected error rates can be set -fastq_maxee e.g. 1.0
echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
