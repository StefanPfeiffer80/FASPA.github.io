...
Files which were generated by the workflow can be further analyzed using R  (R Development Core Team,2008)
, the commonly used statistical language. FASPA files can be uploaded into phyloseq. 
